...
typedef struct {
    ...
    uint8_t     reder_desc1;        // File descriptor 1 for >&, defaults 0
    uint8_t     reder_desc2;        // File descriptor 2 for >&, defaults 0
    bool        reder_desc_first;   // Determines if >& or > was first
